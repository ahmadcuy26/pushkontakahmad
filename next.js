...
browser: ['Fxyz-Botz','4Ksanzz','1.0.0'],
auth: state,
version
})
...
console.log(color(figlet.textSync(`4K SANZZ`, {
font: 'Standard',
horizontalLayout: 'default',
vertivalLayout: 'default',
whitespaceBreak: false
}), 'red'))
console.log(color(figlet.textSync(`FXYZ.0.1`, {
font: 'Standard',
horizontalLayout: 'default',
vertivalLayout: 'default',
whitespaceBreak: false
}), 'white'))
console.log(color('ㅤInfo Script Bot\nㅤ➺ Baileys : Multi Device\nㅤ➺ Nama Script : Push Kontak V6\n\nㅤInfo Creator\nㅤ➺ My YouTube : 4K Sanzz\nㅤ➺ My Instagram : @fhl.dx17\nㅤ➺ My WhatsApp : 6281236167286', 'green'))
